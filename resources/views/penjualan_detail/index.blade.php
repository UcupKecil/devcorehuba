...
<tbody></tbody>
  ...
  <div class="col-md-6">
     <div id="tampil-bayar" style="background: #dd4b39; color: #fff; font-size: 60px; text-align: center; height: 120px"></div>
     <div id="tampil-terbilang" style="background: #3c8dbc; color: #fff; font-size: 20px; padding: 10px"></div>
      @if($errors->any())
        <div style="background: #dd4b39; color: #ffff00; font-size: 38px; padding: 10px"><h1><b>{{$errors->first()}}</b></h1></div>
      @endif
  </div>
...
function selectMember(kode,nama,alamat){
  ...
  //document.getElementById("namamember").value = document.getElementById("nama").value;
  //document.getElementById("alamat_kirim").value = document.getElementById("alamat").value;
...
function loadForm(diskon=0, diterima=0){
  ...
  // $('#namamember').val($('.namamember').text());
  // $('#alamat_kirim').val($('.alamat_kirim').text());
