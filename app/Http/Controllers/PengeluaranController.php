...
class PengeluaranController extends Controller
{
    ...
    public function index()
    {
        ...
        $jenis_pembayaran = JenisPembayaran::where('id_jenis','not like','1000')->where('id_jenis','not like','1003')->get();
        
          
        return view('pengeluaran.index', compact('kategori','jenis_pembayaran'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $pengeluaran->jenis_pembayaran = $request['jenis_pembayaran'];
        $pengeluaran->save();
    }
