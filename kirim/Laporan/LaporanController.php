...
class LaporanController extends Controller
{
    ...
    protected function getData($awal, $akhir){
        ...
        while(strtotime($awal) <= strtotime($akhir)){
            ...
            $total_pembelian = Pengeluaran::where('id_kategori','like','1')->where('tanggal', 'LIKE', "$tanggal%")->sum('nominal');
    ...
    protected function getDataweek($awal, $akhir){
        ...
        while(strtotime($awal) <= strtotime($akhir)){
            ...
            if($count <= "7" and strtotime($awal) <= strtotime($akhir)){
                ...
                $beli = $beli + $total_pembelian;
                $keluar = $keluar + $total_pengeluaran; 
                $pendapatan = $jual - $beli - $keluar;              
                $income = $pendapatan;
                $count ++;
            }else{
                $row = array();
            ...
            $pendapatan2 = $total_penjualan - $total_pembelian - $total_pengeluaran;
