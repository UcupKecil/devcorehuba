...
class MemberMarketingController extends Controller
{
    /**
    ...
    {
        $jenismember = JenisMember::where('id_jenis','not like','1000')->where('jenis_member','=','partner')->get();    
        $kategori = Kategori::where('id_kategori','not like','1000')->where('id_kategori','not like','1003')->get();  
       
      
        return view('member_marketing.index' , compact('jenismember','kategori')); 
    }
    ...
    public function printCard(Request $request)
    {
        ...
        $pdf = PDF::loadView('member_marketing.card', compact('datamember'));
