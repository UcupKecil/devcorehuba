<div class="modal" id="modal-ambil" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
   ...
   <form class="form-horizontal" data-toggle="validator" method="post" action="produk/ambil">
   {{ csrf_field() }} {{ method_field('POST') }}
   <h3 class="modal-title">Pengurangan Stock</h3>
        
<div class="modal-body">
    <?php
        $produk=DB::table('produk')->where('id_kategori','not like','102')->where('jenis_produk','Produksi')->where('stok',"not like",'0')->get();
    ?>
