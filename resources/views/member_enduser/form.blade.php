<div class="modal" id="modal-form" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
   ...
   <form class="form-horizontal" data-toggle="validator" method="post" action="{{route('member.store')}}">
...
<div class="modal-body">
   ...
   <div class="form-group">
    <label for="jenis_member" class="col-md-3 control-label">Jenis Member</label>
    <div class="col-md-6">
      <select id="jenis_member" type="text" class="form-control" name="jenis_member" required>
        <option value=""> -- Pilih Jenis Member-- </option>
        @foreach($jenismember as $list)
        <option value="{{ $list->jenis_member }}">{{ $list->jenis_member }}</option>
        @endforeach
      </select>
      <span class="help-block with-errors"></span>
    </div>
