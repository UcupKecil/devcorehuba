  ...
  <div class="col-md-4">
    <form class="form form-horizontal form-penjualan" method="post" action="transaksi/simpan">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <!-- <div class="input-group"> -->
            <input id="namamember" type="text" class="form-control" name="namamember" placeholder="Isi jika belum ada member">
            <!-- <span class="input-group-btn">
              <button onclick="showMember()" type="button" class="btn btn-info">Add...</button>
            </span> -->
          <!-- </div> -->
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <!-- <div class="input-group"> -->
            <input id="telp" type="text" class="form-control" name="telp" placeholder="Isi jika belum ada member">
            <!-- <span class="input-group-btn">
              <button onclick="showMember()" type="button" class="btn btn-info">Add...</button>
            </span> -->
          <!-- </div> -->
