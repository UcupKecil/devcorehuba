...
class PenjualanMarketingExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        ->where('member.jenis_member', '=', 'marketing')
        ->orderBy('produk.id_produk', 'desc')
        ->get([
                'penjualan.tanggal as tanggal', 'member.nama as namakonsumen', 
