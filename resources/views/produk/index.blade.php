  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        ...
        <a onclick="ambil()" class="btn btn-warning"><i class="fa fa-minus-circle"></i>Pengambilan Huba</a>
        <a onclick="tambah()" class="btn btn-info"><i class="fa fa-plus-circle"></i>Penambahan Huba</a>
      </div>
      <div class="box-body">  
