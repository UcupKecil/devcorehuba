<div class="modal" id="modal-form" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
   ...
   <div class="modal-header">
      ...
      <h3 class="modal-title">Edit Paket Huba</h3>
      @else
...
<div class="modal-body">
  ...
  <input type="hidden" id="jenis" name="jenis" value="Paket">
  <div class="form-group">
    <!-- <label for="kode" class="col-md-3 control-label">Kode ProdukPaket</label> -->
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="nama" class="col-md-3 control-label">Nama ProdukPaket</label>
    <div class="col-md-6">
