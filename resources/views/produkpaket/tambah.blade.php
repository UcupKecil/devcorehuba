<div class="modal" id="modal-tambah" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
   ...
   <form class="form-horizontal" data-toggle="validator" method="post" action="produkpaket/tambah">
   {{ csrf_field() }} {{ method_field('POST') }}
   <h3 class="modal-title">Penambahan Stock Paket Huba</h3>
...
<div class="modal-body">
  ...
  <div class="form-group">
    <label for="kode_produk" class="col-md-3 control-label">Nama ProdukPaket</label>
    <div class="col-md-6">
