...
<div class="modal-body">
   ...
   <!-- <div class="form-group">
      <label for="jenis" class="col-md-3 control-label">Suplier</label>
      <div class="col-md-8">
         <input id="suplier" type="text" class="form-control" name="suplier" autofocus required>
         <span class="help-block with-errors"></span>
      </div>
   </div> -->

   <div class="form-group">
      <label for="suplier" class="col-md-3 control-label">Supplier</label>
      <div class="col-md-6">
         <select id="level" type="text" class="form-control" name="suplier" required>
