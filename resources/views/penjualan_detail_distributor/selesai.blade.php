       ...
       <div class="box-body">
          ...
          <a class="btn btn-warning btn-lg" onclick="tampilNota()">Cetak Nota PDF</a>
            <script type="text/javascript">
              tampilNota();
              function tampilNota(){
                window.open("{{ route('transaksi.pdf') }}", "Nota PDF", "height=1024,width=500,left=150,scrollbars=yes");
              }              
            </script>
          <a class="btn btn-primary btn-lg" href="{{ route('transaksi_distributor.new') }}">Transaksi Distributor Baru</a>
          <br><br><br><br>
      </div>
   </div>
  </div>
